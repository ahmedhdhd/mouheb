          ...
          <div>
            ...
            <p>
              <h3>
                ...
                l’Université de Monastir (ISIMM) est créé par le décret n° 1623
                du 09 juillet 2002, est un établissement d’enseignement
                supérieur scientifique, public, placé sous la tutelle du
                Ministère de l'Enseignement Supérieur de la Recherche
                Scientifique. Dans un premier temps ses formations ont été axées
                sur les métiers de l'Informatique et de ses applications, des
                Mathématiques et ses applications (Modélisation, Statistique).
      ...
      case "item2":
        return (
          <div>
            <h2>
              {" "}
              " L’Institut s’articule autour de trois départements ;
              Informatique, Mathématiques et Technologie. Actuellement le nombre
              d’enseignants permanents est de 26, 18 et 27 respectivement. Les
              enseignements offerts par ces départements pour l’année 2011-2012
